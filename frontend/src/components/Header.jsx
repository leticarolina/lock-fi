...
export default function Header() {
  const { walletAddress, disconnectWallet } = useVault()
    ...
    <header className="border-b border-vault-border/50 bg-vault-bg/80 backdrop-blur-xl sticky top-0 z-50">
      <div className="max-w-2xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          <ShieldIcon size={28} className="text-vault-accent" />
          <span className="font-display font-700 text-lg tracking-tight text-vault-text">
